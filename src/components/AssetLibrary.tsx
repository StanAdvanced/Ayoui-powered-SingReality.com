...
import { Search, Package, Box, User, Trees, Plus } from 'lucide-react';
...
interface Asset {
  id: string;
  name: string;
  category: 'furniture' | 'architecture' | 'characters' | 'environment';
  url: string;
  thumbnail: string;
}
...
const ASSETS: Asset[] = [
  ...
  // Environment
  { id: 'e1', name: 'Quantum Tree', category: 'environment', url: 'https://raw.githubusercontent.com/mrdoob/three.js/master/examples/models/gltf/RobotExpressive/RobotExpressive.glb', thumbnail: 'https://placehold.co/400x300/111/00f0ff?text=Tree' },
];
...
export function AssetLibrary() {
  ...
  const categories = [
    ...
    { id: 'architecture', label: 'Architecture', icon: User },
