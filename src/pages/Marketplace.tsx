...
const ASSETS = [
  ...
  },
  {
    ...
    creator: "NeuralSynth",
    price: 45,
    image: "https://images.unsplash.com/photo-1511379938547-c1f69419868d?q=80&w=800&auto=format&fit=crop", // Music studio
    type: "Neural VST",
    category: "Audio"
  },
  {
    ...
    creator: "Luna AI",
    price: 120,
    image: "https://images.unsplash.com/photo-1516280440502-a2fc994606cf?q=80&w=800&auto=format&fit=crop", // Singer
    type: "Vocal Identity",
    category: "Audio"
  },
  {
    ...
    creator: "SpatialLabs",
    price: 30,
    image: "https://images.unsplash.com/photo-1470229722913-7c090b332da8?q=80&w=800&auto=format&fit=crop", // Concert
    type: "Environment",
    category: "Audio"
  },
  {
    ...
    creator: "BeatBot",
    price: 25,
    image: "https://images.unsplash.com/photo-1519892300165-cb5542fb47c7?q=80&w=800&auto=format&fit=crop", // Drums
    type: "Stem Pack",
    category: "Audio"
  },
  {
    ...
    creator: "3DForge",
    price: 15,
    image: "https://images.unsplash.com/photo-1571266028243-3716f02d2d2e?q=80&w=800&auto=format&fit=crop", // DJ Deck
    type: "3D Model",
    category: "Furniture"
  },
  {
    ...
    creator: "Architex",
    price: 80,
    image: "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?q=80&w=800&auto=format&fit=crop", // Stage
    type: "3D Model",
  ...
  },
  {
    ...
    price: 55,
    image: "https://images.unsplash.com/photo-1510915361894-db8b60106cb1?q=80&w=800&auto=format&fit=crop", // Guitar
    type: "3D Model",
  ...
  },
  {
    ...
    creator: "MatMaster",
    price: 10,
    image: "https://images.unsplash.com/photo-1461360228754-6e81c478b882?q=80&w=800&auto=format&fit=crop", // Vinyl
    type: "Texture",
    category: "Materials"
  },
  {
    ...
    creator: "ChillVibes",
    price: 20,
    image: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=800&auto=format&fit=crop", // Headphones
    type: "Stem Pack",
    category: "Audio"
  },
  {
    ...
    creator: "Keys3D",
    price: 65,
    image: "https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?q=80&w=800&auto=format&fit=crop", // Piano
    type: "3D Model",
    category: "Instruments"
  },
  {
    ...
    creator: "AtmosFX",
    price: 12,
    image: "https://images.unsplash.com/photo-1540039155732-d674d6e3f0be?q=80&w=800&auto=format&fit=crop", // Crowd
    type: "Environment",
    category: "Audio"
  },
  {
    ...
    creator: "Retro3D",
    price: 25,
    image: "https://images.unsplash.com/photo-1520166012956-add9ba083586?q=80&w=800&auto=format&fit=crop", // Mic
    type: "3D Model",
    category: "Instruments"
  },
  {
    ...
    creator: "NeonSound",
    price: 35,
    image: "https://images.unsplash.com/photo-1550684376-efcbd6e3f031?q=80&w=800&auto=format&fit=crop", // Synth
    type: "Neural VST",
    category: "Audio"
  },
  {
    ...
    creator: "BassDrop",
    price: 40,
    image: "https://images.unsplash.com/photo-1545128485-c400e7702796?q=80&w=800&auto=format&fit=crop", // Speakers
    type: "3D Model",
    category: "Furniture"
  },
  {
    ...
    creator: "BlingMats",
    price: 15,
    image: "https://images.unsplash.com/photo-1602722053020-af31042989d5?q=80&w=800&auto=format&fit=crop", // Gold Record
    type: "Texture",
    category: "Materials"
  },
  {
    ...
    creator: "SpatialLabs",
    price: 45,
    image: "https://images.unsplash.com/photo-1507676184212-d0330a15233c?q=80&w=800&auto=format&fit=crop", // Opera
    type: "Environment",
    category: "Audio"
  }
];
      ...
      <div className="flex flex-wrap gap-3 mb-6 mt-12">
        {CATEGORIES.map(cat => (
          <button
            ...
            className={`px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest transition-all ${activeCategory === cat ? 'bg-singularity text-black' : 'glass hover:bg-white/10'}`}
          >
            {cat}
          </button>
        ))}
      ...
      <div className="flex flex-wrap gap-3 mb-12">
        {["All", "Neural VST", "3D Model", "Texture", "Stem Pack", "Environment"].map(type => (
          <button
            ...
            className={`px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest transition-all ${activeType === type ? 'bg-quantum text-black' : 'glass hover:bg-white/10'}`}
          >
            {type}
          </button>
        ))}
